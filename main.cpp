...
void ShowInfo()
{
    ...
    setcolor(0x07);printf("#############\n"); 
    printf("     #    WOLFESNTEIN RPG EXTRACTOR    #\n");
    printf("     # CREADO POR ERICK VASQUEZ GARCIA #\n");
    printf("     #     ES PARA WOLFESNTEIN RPG     #\n");
    printf("     #         VERSION 4.1.29          #\n");
    printf("     #          MODO DE USO:           #\n");
...
void ExtraerDatos()
{
    hz = OpenZip(("wolfenstein_rpg_v_4.1.29.jar"),0);
    if(hz == NULL){error("No encuentra wolfenstein_rpg_v_4.1.29.jar");}
...
int main(int argc, char *argv[])
{
    ...
    hz = CreateZip("WolfensteinRpg.pk3",0);
